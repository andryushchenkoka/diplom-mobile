...
public class MobileDriver implements WebDriverProvider {
    ...
    static LocalMobileConfig config = ConfigFactory.create(LocalMobileConfig.class);
    ...
    public WebDriver createDriver(Capabilities capabilities) {
        ...
        options.setAutomationName(ANDROID_UIAUTOMATOR2)
                ...
                .setApp(getAppPath())
                .setAppPackage(config.getLocalApppackage())
                .setAppActivity(config.getLocalAppactivity());
